...
// Setup and configure Express http server. Expect
// a subfolder called "static" to be the web root.
var httpApp = express();
...
// Overriding the default easyrtcAuth listener, only so we can
// directly access its callback
easyrtc.events.on("easyrtcAuth", function(socket, easyrtcid, msg,
 socketCallback, callback)
{
 easyrtc.events.defaultListeners.easyrtcAuth(socket, easyrtcid,
 msg, socketCallback, function(err, connectionObj){
...
easyrtc.events.on("roomJoin", function(connectionObj, roomName,
...
var rtc = easyrtc.listen(httpApp, socketServer, null,
 function(err, rtcRef) {
